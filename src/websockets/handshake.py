...
def build_request(headers: Headers) -> str:
    """
    Builds a handshake request to send to the server.
...
def check_request(headers: Headers) -> str:
    """
    Checks a handshake request received from the client.
...
def build_response(headers: Headers, key: str) -> None:
    """
    Builds a handshake response to send to the client.

    Updates response headers passed in argument.

    :param Headers headers: response headers
    :param str key: comes from :func:`check_request`
...
def check_response(headers: Headers, key: str) -> None:
    """
    Checks a handshake response received from the server.
    ...
    :param Headers headers: response headers
    :param str key: comes from :func:`build_request`
